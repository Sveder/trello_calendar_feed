...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Board.board_id'
        db.add_column('theapp_board', 'board_id',
                      self.gf('django.db.models.fields.CharField')(default='lala', max_length=100),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('theapp_board', 'name',
                      self.gf('django.db.models.fields.TextField')(default='moo'),
                      keep_default=False)

        # Deleting field 'Board.board_id'
        db.delete_column('theapp_board', 'board_id')


    models = {
        'theapp.board': {
            'Meta': {'object_name': 'Board'},
            'board_id': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
